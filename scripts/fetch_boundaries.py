...
COUNTRY_CONFIG = {
    ...
    "FO": {"admin_level": 7, "iso": "FO", "name": "Faroe Islands"},
    # Oceania
    ...
    # South America
    "AR": {"admin_level": 8, "iso": "AR", "name": "Argentina"},
    "BO": {"admin_level": 8, "iso": "BO", "name": "Bolivia"},
    ...
    "PY": {"admin_level": 8, "iso": "PY", "name": "Paraguay"},
    ...
    "LY": {"admin_level": 4, "iso": "LY", "name": "Libya"},
    "MA": {"admin_level": 6, "iso": "MA", "name": "Morocco"},
    "TN": {"admin_level": 6, "iso": "TN", "name": "Tunisia"},
    "SD": {"admin_level": 4, "iso": "SD", "name": "Sudan"},
    # Africa — West
    "BJ": {"admin_level": 6, "iso": "BJ", "name": "Benin"},
    "BF": {"admin_level": 6, "iso": "BF", "name": "Burkina Faso"},
    "CV": {"admin_level": 6, "iso": "CV", "name": "Cape Verde"},
    "CI": {"admin_level": 6, "iso": "CI", "name": "Côte d'Ivoire"},
    "GM": {"admin_level": 6, "iso": "GM", "name": "Gambia"},
    "GH": {"admin_level": 6, "iso": "GH", "name": "Ghana"},
    "GN": {"admin_level": 6, "iso": "GN", "name": "Guinea"},
    "GW": {"admin_level": 6, "iso": "GW", "name": "Guinea-Bissau"},
    "LR": {"admin_level": 4, "iso": "LR", "name": "Liberia"},
    "ML": {"admin_level": 6, "iso": "ML", "name": "Mali"},
    "MR": {"admin_level": 6, "iso": "MR", "name": "Mauritania"},
    "NE": {"admin_level": 6, "iso": "NE", "name": "Niger"},
    "NG": {"admin_level": 6, "iso": "NG", "name": "Nigeria"},
    "SN": {"admin_level": 6, "iso": "SN", "name": "Senegal"},
    "SL": {"admin_level": 6, "iso": "SL", "name": "Sierra Leone"},
    "TG": {"admin_level": 6, "iso": "TG", "name": "Togo"},
    # Africa — Central
    "CM": {"admin_level": 6, "iso": "CM", "name": "Cameroon"},
    "CF": {"admin_level": 6, "iso": "CF", "name": "Central African Republic"},
    "TD": {"admin_level": 6, "iso": "TD", "name": "Chad"},
    "CG": {"admin_level": 6, "iso": "CG", "name": "Congo"},
    "CD": {"admin_level": 4, "iso": "CD", "name": "DR Congo"},
    "GQ": {"admin_level": 4, "iso": "GQ", "name": "Equatorial Guinea"},
    "GA": {"admin_level": 6, "iso": "GA", "name": "Gabon"},
    "ST": {"admin_level": 6, "iso": "ST", "name": "São Tomé and Príncipe"},
    # Africa — East
    "BI": {"admin_level": 6, "iso": "BI", "name": "Burundi"},
    "KM": {"admin_level": 4, "iso": "KM", "name": "Comoros"},
    "DJ": {"admin_level": 4, "iso": "DJ", "name": "Djibouti"},
    "ER": {"admin_level": 4, "iso": "ER", "name": "Eritrea"},
    "ET": {"admin_level": 4, "iso": "ET", "name": "Ethiopia"},
    "KE": {"admin_level": 4, "iso": "KE", "name": "Kenya"},
    "MG": {"admin_level": 4, "iso": "MG", "name": "Madagascar"},
    "MW": {"admin_level": 4, "iso": "MW", "name": "Malawi"},
    "MU": {"admin_level": 6, "iso": "MU", "name": "Mauritius"},
    "MZ": {"admin_level": 4, "iso": "MZ", "name": "Mozambique"},
    "RW": {"admin_level": 6, "iso": "RW", "name": "Rwanda"},
    "SC": {"admin_level": 6, "iso": "SC", "name": "Seychelles"},
    "SO": {"admin_level": 4, "iso": "SO", "name": "Somalia"},
    "SS": {"admin_level": 4, "iso": "SS", "name": "South Sudan"},
    "TZ": {"admin_level": 4, "iso": "TZ", "name": "Tanzania"},
    "UG": {"admin_level": 4, "iso": "UG", "name": "Uganda"},
    # Africa — Southern
    "AO": {"admin_level": 6, "iso": "AO", "name": "Angola"},
    "BW": {"admin_level": 4, "iso": "BW", "name": "Botswana"},
    "SZ": {"admin_level": 6, "iso": "SZ", "name": "Eswatini"},
    "LS": {"admin_level": 6, "iso": "LS", "name": "Lesotho"},
    "NA": {"admin_level": 4, "iso": "NA", "name": "Namibia"},
