...
class TestLoadSeedData:
    def test_loads_all_countries(self):
        ...
        assert countries >= {"EE", "LV", "LT", "FI", "NO", "SE", "DE", "DK", "IE", "NL", "SK", "GB", "BG", "HR", "CY", "GR", "HU", "MT", "RO", "AL", "XK", "ME", "BA", "RS", "MK", "UA", "MD", "LI", "SM", "GE", "AM", "AZ", "BY", "TR", "AU", "NZ", "ID", "PG", "MY", "TH", "KH", "PH", "VN", "MM", "OM", "AE", "QA", "BH", "FJ", "WS", "VU", "TO", "NR", "PW"}
