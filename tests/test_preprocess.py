...
class TestLoadSeedData:
    def test_loads_all_countries(self):
        ...
        assert countries >= {"EE", "LV", "LT", "FI", "NO", "SE", "DE", "DK", "IE", "NL", "SK", "GB", "BG", "HR", "CY", "GR", "HU", "MT", "RO", "AL", "XK", "ME", "BA", "RS", "MK", "UA", "MD", "LI", "SM", "GE", "AM", "AZ", "BY", "TR", "AU", "NZ", "ID", "PG", "MY", "TH", "KH", "PH", "VN", "MM", "OM", "AE", "QA", "BH", "FJ", "WS", "VU", "TO", "NR", "PW", "JP", "TW", "KR", "KP", "CN", "MN", "IN", "BD", "PK", "LK", "NP", "LA", "BN", "TL", "KZ", "UZ", "KG", "RU", "SA", "IQ", "JO", "LB", "KW", "IR", "IL", "AR", "BO", "BR", "CL", "CO", "EC", "GY", "PE", "PY", "SR", "UY", "VE", "CA", "MX", "BZ", "GT", "HN", "SV", "NI", "CR", "PA", "DZ", "EG", "LY", "MA", "TN", "SD", "BJ", "BF", "CV", "CI", "GM", "GH", "GN", "GW", "LR", "ML", "MR", "NE", "NG", "SN", "SL", "TG", "CM", "CF", "TD", "CG", "CD", "GQ", "GA", "ST", "BI", "KM", "DJ", "ER", "ET", "KE", "MG", "MW", "MU", "MZ", "RW", "SC", "SO", "SS", "TZ", "UG", "AO", "BW", "SZ", "LS", "NA", "ZA", "ZM", "ZW", "CU", "HT", "DO", "JM", "TT", "BS", "BB", "AG", "DM", "GD", "KN", "LC", "VC", "AF", "SG", "YE", "SY", "PS", "TJ", "TM", "MV", "BT", "SB", "MH", "FM", "KI", "TV"}
